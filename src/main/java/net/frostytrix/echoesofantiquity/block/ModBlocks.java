...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(EchoesOfAntiquityMod.MOD_ID);

    public static final DeferredBlock<Block> VOID_ANCHOR = registerBlock("void_anchor",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(3F, 9F).requiresCorrectToolForDrops().sound(SoundType.STONE)));
